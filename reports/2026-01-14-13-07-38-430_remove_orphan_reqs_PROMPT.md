# Remove Orphan Reqs [PROMPT]
**Timestamp:** 2026-01-14-13-07-38-430
**Requirement:** N/A
...
Orphan $REQ_IDs to remove:
  $REQ_CLI_006:
    - code\Program.cs:48 (code)
    - tests\passing\01_cli.py:184 (tests)
    - tests\passing\01_cli.py:202 (tests)
    - tests\passing\01_cli.py:255 (tests)
    - tests\passing\01_cli.py:266 (tests)
    - tests\passing\01_cli.py:270 (tests)
    - tests\passing\01_cli.py:272 (tests)
  $REQ_ID:
    - code\Database.cs:88 (code)
    - code\TreeBuilder.cs:20 (code)
    - code\TreeBuilder.cs:133 (code)
