# Fix Attempt1 [PROMPT]
**Timestamp:** 2026-01-14-13-48-20-775
...
- **Requirement:** reqs\02_path-canonicalization.md
- **Test:** tests/failing/02_path-canonicalization.py
...
```bash
C:\Users\Human\Desktop\prjx\vecsum\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/test.py tests/failing/02_path-canonicalization.py
```
...
```bash
C:\Users\Human\Desktop\prjx\vecsum\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/track-reqIDs.py $REQ_ID
```
...
```bash
C:\Users\Human\Desktop\prjx\vecsum\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/visual-test.py <image_path>... "<assertion>" --test-script <test_file>
```
...
```bash
C:\Users\Human\Desktop\prjx\vecsum\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/code-inspection-assertion.py "<assertion>" --code-path ./code
```
...
```bash
C:\Users\Human\Desktop\prjx\vecsum\ai-coder\bin\uv.exe run playwright install
```

## What You Can Modify

- `./code/*` -- implementation files
- `tests/failing/02_path-canonicalization.py` -- the test file for this requirement
