# Fix Attempt1 [PROMPT]
**Timestamp:** 2026-01-14-14-12-08-752
...
- **Requirement:** reqs\04_summary-retrieval.md
- **Test:** tests/failing/04_summary-retrieval.py
...
```bash
C:\Users\Human\Desktop\prjx\vecsum\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/test.py tests/failing/04_summary-retrieval.py
```
...
- `tests/failing/04_summary-retrieval.py` -- the test file for this requirement
