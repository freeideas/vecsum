# Fix Attempt1 [PROMPT]
**Timestamp:** 2026-01-14-14-24-10-995
...
- **Requirement:** reqs\02_error-handling.md
- **Test:** tests/failing/02_error-handling.py
...
```bash
C:\Users\Human\Desktop\prjx\vecsum\ai-coder\bin\uv.exe run --script ./ai-coder/scripts/test.py tests/failing/02_error-handling.py
```
...
- `tests/failing/02_error-handling.py` -- the test file for this requirement
